  ...
  render(
    ...
    svg(
      ...
      [
        path(
          [
            class("clock-frame fill-black dark:fill-white"),
            d(
        ...
        line(
          [
            class("clock-hour-hand stroke-black dark:stroke-white"),
            id("clock-hour-hand"),
        ...
        line(
          [
            class("clock-minute-hand stroke-black dark:stroke-white"),
        ...
        g(
          ...
          [
            line(
              [
                class("clock-second-hand-arm stroke-[#D53A1F]"),
                fill("none"),
                stroke_width("4"),
                stroke_miterlimit("10"),
                x1("192"),
            ...
            circle(
              [
                class("clock-second-hand-axis fill-[#D53A1F]"),
                cx("192"),
                cy("192"),
                r("4.5"),
              ],
