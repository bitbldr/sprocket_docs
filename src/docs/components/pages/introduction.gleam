  ...
  render(
    ...
    article([], [
      ...
      p([], [
        text(
          "
                  Sprocket is designed around a collection of functional patterns that empower developers to build application interfaces with ease.
      ...
      p([], [
        text(
          "
                  ...
                  Sprocket is built on a solid foundation that enables scalable and fault-tolerant applications.
                ",
        ),
      ]),
      ...
      p([], [
        ul([], [
          li([], [
            span([class("font-bold")], [text("Real-time Components: ")]),
            text(
